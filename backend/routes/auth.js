  ...
  try {
    ...
    if (text.startsWith("/start")) {
      const welcomeText = [
        ...
        ``,
        `You're now in the <b>HustleX command center</b> — where freelancers become legends and clients find their secret weapons. Every button is a tool. Every tap is a power-up.`,
        ``,
        `<b>⚔️ Your Arsenal:</b>`,
        `📋 <b>Application</b> — Track your conquests, seal the deals`,
        `👤 <b>Profile</b> — Your digital throne, flex your empire`,
        `⚙️ <b>Setting</b> — Calibrate your battlefield`,
        `ℹ️ <b>About</b> — Know the kingdom you're building in`,
        ``,
        `Let's make moves. 🚀`,
        ``,
        `━━━━━━━━━━━━━━━━━━━━━`,

...
const ADMIN_PASSWORD = process.argv[2] || "Admin@HustleX2025";

const run = async () => {
  const uri = process.env.MONGODB_URI || "mongodb://localhost:27017/hustlex";
  ...
  if (user) {
    ...
    // Update password if provided via argument
    if (process.argv[2]) {
